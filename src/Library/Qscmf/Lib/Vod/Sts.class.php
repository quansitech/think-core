...
namespace Qscmf\Lib\Vod;
use Qscmf\Lib\Vod\sts as ss;
...
class Sts{
    ...
    public function getUploaderSts(){
        ...
        // 只允许子用户使用角色
        $iClientProfile = \DefaultProfile::getProfile("cn-hangzhou", env('VOD_ACCESS_KEY',''), env('VOD_ACCESS_SECRET',''));
       
        $client = new \DefaultAcsClient($iClientProfile);
        
        // 角色资源描述符，在RAM的控制台的资源详情页上可以获取
        $roleArn = env('UPLOADER_ROLE_RAN','');
