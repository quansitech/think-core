! function (e) {
    ...
    var i = function (t, i) {
        ...
        for (var o = 3 === this.bootcssVer ? n.templateV3 : n.template; - 1 !== o.indexOf("{iconType}");) o = o.replace("{iconType}", this.icontype);
    ...
    i.prototype = {
        ...
        _attachEvents: function () {
            ...
            for (var t, i, a = 0; a < this._events.length; a++) t = this._events[a][0], i = this._events[a][1], t.on(i)
        },
        ...
        place: function () {
            if (!this.isInline) {
                ...
                var i, a, s, n;
                n = this.container instanceof e ? this.container.offset() : e(this.container).offset(), this.component ? (i = this.component.offset(), s = i.left, ("bottom-left" == this.pickerPosition || "top-left" == this.pickerPosition) && (s += this.component.outerWidth() - this.picker.outerWidth())) : (i = this.element.offset(), s = i.left);
                var o = document.body.clientWidth || window.innerWidth;
                s + 220 > o && (s = o - 220), a = "top-left" == this.pickerPosition || "top-right" == this.pickerPosition ? i.top - this.picker.outerHeight() : i.top + this.height, a -= n.top, s -= n.left, this.picker.css({
                    top: a,
                    left: s,
                    zIndex: this.zIndex
                })
        ...
        fill: function () {
            if (null != this.date && null != this.viewDate) {
                var i = new Date(this.viewDate),
                    ...
                    m = new Date;
                if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(s[this.language].months[o] + " " + a), "time" == this.formatViewType) {
                ...
                } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(r + " " + s[this.language].months[o] + " " + a), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(r + " " + s[this.language].months[o] + " " + a);
                this.picker.find("tfoot th.today").text(s[this.language].today).toggle(this.todayBtn !== !1), this.updateNavArrows(), this.fillMonths();
                var v = t(a, o - 1, 28, 0, 0, 0, 0),
                    w = n.getDaysInMonth(v.getUTCFullYear(), v.getUTCMonth());
                v.setUTCDate(w), v.setUTCDate(w - (v.getUTCDay() - this.weekStart + 7) % 7);
                var D = new Date(v);
                D.setUTCDate(D.getUTCDate() + 42), D = D.valueOf();
                for (var y, b = []; v.valueOf() < D;) v.getUTCDay() == this.weekStart && b.push("<tr>"), y = "", v.getUTCFullYear() < a || v.getUTCFullYear() == a && v.getUTCMonth() < o ? y += " old" : (v.getUTCFullYear() > a || v.getUTCFullYear() == a && v.getUTCMonth() > o) && (y += " new"), this.todayHighlight && v.getUTCFullYear() == m.getFullYear() && v.getUTCMonth() == m.getMonth() && v.getUTCDate() == m.getDate() && (y += " today"), v.valueOf() == f && (y += " active"), (v.valueOf() + 864e5 <= this.startDate || v.valueOf() > this.endDate || -1 !== e.inArray(v.getUTCDay(), this.daysOfWeekDisabled)) && (y += " disabled"), b.push('<td class="day' + y + '">' + v.getUTCDate() + "</td>"), v.getUTCDay() == this.weekEnd && b.push("</tr>"), v.setUTCDate(v.getUTCDate() + 1);
                this.picker.find(".datetimepicker-days tbody").empty().append(b.join("")), b = [];
                for (var T = "", M = "", C = "", k = this.hoursDisabled || [], U = 0; 24 > U; U++)
                    if (-1 === k.indexOf(U)) {
                        var x = t(a, o, r, U);
                        y = "", x.valueOf() + 36e5 <= this.startDate || x.valueOf() > this.endDate ? y += " disabled" : l == U && (y += " active"), this.showMeridian && 2 == s[this.language].meridiem.length ? (M = 12 > U ? s[this.language].meridiem[0] : s[this.language].meridiem[1], M != C && ("" != C && b.push("</fieldset>"), b.push('<fieldset class="hour"><legend>' + M.toUpperCase() + "</legend>")), C = M, T = U % 12 ? U % 12 : 12, b.push('<span class="hour' + y + " hour_" + (12 > U ? "am" : "pm") + '">' + T + "</span>"), 23 == U && b.push("</fieldset>")) : (T = U + ":00", b.push('<span class="hour' + y + '">' + T + "</span>"))
                    } this.picker.find(".datetimepicker-hours td").html(b.join("")), b = [], T = "", M = "", C = "";
                for (var I = this.minutesDisabled || [], U = 0; 60 > U; U += this.minuteStep)
                    if (-1 === I.indexOf(U)) {
                        var x = t(a, o, r, l, U, 0);
                        y = "", x.valueOf() < this.startDate || x.valueOf() > this.endDate ? y += " disabled" : Math.floor(d / this.minuteStep) == Math.floor(U / this.minuteStep) && (y += " active"), this.showMeridian && 2 == s[this.language].meridiem.length ? (M = 12 > l ? s[this.language].meridiem[0] : s[this.language].meridiem[1], M != C && ("" != C && b.push("</fieldset>"), b.push('<fieldset class="minute"><legend>' + M.toUpperCase() + "</legend>")), C = M, T = l % 12 ? l % 12 : 12, b.push('<span class="minute' + y + '">' + T + ":" + (10 > U ? "0" + U : U) + "</span>"), 59 == U && b.push("</fieldset>")) : (T = U + ":00", b.push('<span class="minute' + y + '">' + l + ":" + (10 > U ? "0" + U : U) + "</span>"))
                    } this.picker.find(".datetimepicker-minutes td").html(b.join(""));
                var S = this.date.getUTCFullYear(),
                    F = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(a).end().find("span").removeClass("active");
                if (S == a) {
                    var z = F.length - 12;
                    F.eq(this.date.getUTCMonth() + z).addClass("active")
                }(h > a || a > u) && F.addClass("disabled"), a == h && F.slice(0, c + 1).addClass("disabled"), a == u && F.slice(p).addClass("disabled"), b = "", a = 10 * parseInt(a / 10, 10);
                var V = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(a + "-" + (a + 9)).end().find("td");
                a -= 1;
                for (var U = -1; 11 > U; U++) b += '<span class="year' + (-1 == U || 10 == U ? " old" : "") + (S == a ? " active" : "") + (h > a || a > u ? " disabled" : "") + '">' + a + "</span>", a += 1;
                V.html(b), this.place()
            }
        },
        ...
        click: function (i) {
            ...
            var a = e(i.target).closest("span, td, th, legend");
            if (a.is("." + this.icontype) && (a = e(a).parent().closest("span, td, th, legend")), 1 == a.length) {
                if (a.is(".disabled")) return void this.element.trigger({
                    type: "outOfRange",
                    date: this.viewDate,
                    startDate: this.startDate,
                    endDate: this.endDate
                ...
                switch (a[0].nodeName.toLowerCase()) {
                    case "th":
                        switch (a[0].className) {
                            ...
                            case "prev":
                            case "next":
                                var s = n.modes[this.viewMode].navStep * ("prev" == a[0].className ? -1 : 1);
                                switch (this.viewMode) {
                                    case 0:
                                ...
                                this.fill(), this.element.trigger({
                                    type: a[0].className + ":" + this.convertViewModeText(this.viewMode),
                                    date: this.viewDate,
                                    startDate: this.startDate,
                                    endDate: this.endDate
                                });
                    ...
                    case "span":
                        if (!a.is(".disabled")) {
                            ...
                            if (a.is(".month") ? (this.viewDate.setUTCDate(1), l = a.parent().find("span").index(a), d = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(l), this.element.trigger({
                                    type: "changeMonth",
                                    date: this.viewDate
                                }), this.viewSelect >= 3 && this._setDate(t(r, l, d, h, c, u, 0))) : a.is(".year") ? (this.viewDate.setUTCDate(1), r = parseInt(a.text(), 10) || 0, this.viewDate.setUTCFullYear(r), this.element.trigger({
                                    type: "changeYear",
                                    date: this.viewDate
                                }), this.viewSelect >= 4 && this._setDate(t(r, l, d, h, c, u, 0))) : a.is(".hour") ? (h = parseInt(a.text(), 10) || 0, (a.hasClass("hour_am") || a.hasClass("hour_pm")) && (12 == h && a.hasClass("hour_am") ? h = 0 : 12 != h && a.hasClass("hour_pm") && (h += 12)), this.viewDate.setUTCHours(h), this.element.trigger({
                                    type: "changeHour",
                                    date: this.viewDate
                                }), this.viewSelect >= 1 && this._setDate(t(r, l, d, h, c, u, 0))) : a.is(".minute") && (c = parseInt(a.text().substr(a.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(c), this.element.trigger({
                                    type: "changeMinute",
                                    date: this.viewDate
                                }), this.viewSelect >= 0 && this._setDate(t(r, l, d, h, c, u, 0))), 0 != this.viewMode) {
                                var p = this.viewMode;
                    ...
                    case "td":
                        if (a.is(".day") && !a.is(".disabled")) {
                            var d = parseInt(a.text(), 10) || 1,
                                r = this.viewDate.getUTCFullYear(),
                                l = this.viewDate.getUTCMonth(),
                                h = this.viewDate.getUTCHours(),
                                c = this.viewDate.getUTCMinutes(),
                                u = this.viewDate.getUTCSeconds();
                            a.is(".old") ? 0 === l ? (l = 11, r -= 1) : l -= 1 : a.is(".new") && (11 == l ? (l = 0, r += 1) : l += 1), this.viewDate.setUTCFullYear(r), this.viewDate.setUTCMonth(l, d), this.element.trigger({
                                type: "changeDay",
                                date: this.viewDate
                            }), this.viewSelect >= 2 && this._setDate(t(r, l, d, h, c, u, 0))
                        }
                        var p = this.viewMode;
                        this.showMode(-1), this.fill(), p == this.viewMode && this.autoclose && this.hide()
                }
        ...
        moveMonth: function (e, t) {
            ...
            var i, a, s = new Date(e.valueOf()),
                ...
                o = s.getUTCMonth(),
                r = Math.abs(t);
            if (t = t > 0 ? 1 : -1, 1 == r) a = -1 == t ? function () {
                return s.getUTCMonth() == o
            } : function () {
                return s.getUTCMonth() != i
            }, i = o + t, s.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12);
            else {
                for (var l = 0; r > l; l++) s = this.moveMonth(s, t);
        ...
        keydown: function (e) {
            ...
            switch (e.keyCode) {
                ...
                case 39:
                    ...
                    t = 37 == e.keyCode ? -1 : 1, viewMode = this.viewMode, e.ctrlKey ? viewMode += 2 : e.shiftKey && (viewMode += 1), 4 == viewMode ? (i = this.moveYear(this.date, t), a = this.moveYear(this.viewDate, t)) : 3 == viewMode ? (i = this.moveMonth(this.date, t), a = this.moveMonth(this.viewDate, t)) : 2 == viewMode ? (i = this.moveDate(this.date, t), a = this.moveDate(this.viewDate, t)) : 1 == viewMode ? (i = this.moveHour(this.date, t), a = this.moveHour(this.viewDate, t)) : 0 == viewMode && (i = this.moveMinute(this.date, t), a = this.moveMinute(this.viewDate, t)), this.dateWithinRange(i) && (this.date = i, this.viewDate = a, this.setValue(), this.update(), e.preventDefault(), s = !0);
                    break;
                case 38:
                case 40:
                    if (!this.keyboardNavigation) break;
                    t = 38 == e.keyCode ? -1 : 1, viewMode = this.viewMode, e.ctrlKey ? viewMode += 2 : e.shiftKey && (viewMode += 1), 4 == viewMode ? (i = this.moveYear(this.date, t), a = this.moveYear(this.viewDate, t)) : 3 == viewMode ? (i = this.moveMonth(this.date, t), a = this.moveMonth(this.viewDate, t)) : 2 == viewMode ? (i = this.moveDate(this.date, 7 * t), a = this.moveDate(this.viewDate, 7 * t)) : 1 == viewMode ? this.showMeridian ? (i = this.moveHour(this.date, 6 * t), a = this.moveHour(this.viewDate, 6 * t)) : (i = this.moveHour(this.date, 4 * t), a = this.moveHour(this.viewDate, 4 * t)) : 0 == viewMode && (i = this.moveMinute(this.date, 4 * t), a = this.moveMinute(this.viewDate, 4 * t)), this.dateWithinRange(i) && (this.date = i, this.viewDate = a, this.setValue(), this.update(), e.preventDefault(), s = !0);
                    break;
                case 13:
                    if (0 != this.viewMode) {
                        var n = this.viewMode;
    ...
    e.fn.datetimepicker = function (t) {
        ...
        return this.each(function () {
            var n = e(this),
                o = n.data("datetimepicker"),
                r = "object" == typeof t && t;
            return o || n.data("datetimepicker", o = new i(this, e.extend({}, e.fn.datetimepicker.defaults, r))), "string" == typeof t && "function" == typeof o[t] && (s = o[t].apply(o, a), void 0 !== s) ? !1 : void 0
        }), void 0 !== s ? s : this
        ...
        n = {
            ...
            parseFormat: function (e, t) {
                var i = e.replace(this.validParts(t), "\x00").split("\x00"),
                    a = e.match(this.validParts(t));
                if (!i || !i.length || !a || 0 == a.length) throw new Error("Invalid date format.");
                return {
                    separators: i,
                    parts: a
                }
            ...
            parseDate: function (a, n, o, r) {
                ...
                if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(a) && (n = this.parseFormat("yyyy-mm-dd", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(a) && (n = this.parseFormat("yyyy-mm-dd hh:ii", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(a) && (n = this.parseFormat("yyyy-mm-dd hh:ii:ss", r)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(a)) {
                    var d, h, c = /([-+]\d+)([dmwy])/,
                        u = a.match(/([-+]\d+)([dmwy])/g);
                    a = new Date;
                    for (var p = 0; p < u.length; p++) switch (d = c.exec(u[p]), h = parseInt(d[1]), d[2]) {
                        case "d":
                            a.setUTCDate(a.getUTCDate() + h);
                            break;
                        case "m":
                            a = i.prototype.moveMonth.call(i.prototype, a, h);
                            break;
                        case "w":
                            a.setUTCDate(a.getUTCDate() + 7 * h);
                            break;
                        case "y":
                            a = i.prototype.moveYear.call(i.prototype, a, h)
                    }
                    return t(a.getUTCFullYear(), a.getUTCMonth(), a.getUTCDate(), a.getUTCHours(), a.getUTCMinutes(), a.getUTCSeconds(), 0)
                }
                var f, m, d, u = a && a.toString().match(this.nonpunctuation) || [],
                ...
                if (w.M = w.MM = w.mm = w.m, w.dd = w.d, w.P = w.p, a = t(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds()), u.length == n.parts.length) {
                    for (var p = 0, D = n.parts.length; D > p; p++) {
                        if (f = parseInt(u[p], 10), d = n.parts[p], isNaN(f)) switch (d) {
                            case "MM":
                                m = e(s[o].months).filter(function () {
                                    var e = this.slice(0, u[p].length),
                                        t = u[p].slice(0, e.length);
                                    return e == t
                                }), f = e.inArray(m[0], s[o].months) + 1;
                                break;
                            case "M":
                                ...
                                }), f = e.inArray(m[0], s[o].monthsShort) + 1;
                                break;
                            case "p":
                            case "P":
                                f = e.inArray(u[p].toLowerCase(), s[o].meridiem)
                        }
                        g[d] = f
                    }
                    for (var y, p = 0; p < v.length; p++) y = v[p], y in g && !isNaN(g[y]) && w[y](a, g[y])
                }
                return a
            },
            formatDate: function (t, i, a, o) {
                ...
                if ("standard" == o) r = {
                    ...
                    i: t.getUTCMinutes(),
                    s: t.getUTCSeconds()
                }, 2 == s[a].meridiem.length ? r.H = r.h % 12 == 0 ? 12 : r.h % 12 : r.H = r.h, r.HH = (r.H < 10 ? "0" : "") + r.H, r.P = r.p.toUpperCase(), r.hh = (r.h < 10 ? "0" : "") + r.h, r.ii = (r.i < 10 ? "0" : "") + r.i, r.ss = (r.s < 10 ? "0" : "") + r.s, r.dd = (r.d < 10 ? "0" : "") + r.d, r.mm = (r.m < 10 ? "0" : "") + r.m;
                else {
                ...
                for (var t = [], l = e.extend([], i.separators), d = 0, h = i.parts.length; h > d; d++) l.length && t.push(l.shift()), t.push(r[i.parts[d]]);
...
function (e) {
    e.fn.dragsort = function (t) {
        ...
        var i = e.extend({}, e.fn.dragsort.defaults, t),
            a = [],
            s = null,
            n = null;
        return this.each(function (t, o) {
            e(o).is("table") && 1 == e(o).children().size() && e(o).children().is("tbody") && (o = e(o).children().get(0));
            var r = {
                draggedItem: null,
                ...
                container: o,
                init: function () {
                    i.tagName = 0 == e(this.container).children().size() ? "li" : e(this.container).children().get(0).tagName.toLowerCase(), "" == i.itemSelector && (i.itemSelector = i.tagName), "" == i.dragSelector && (i.dragSelector = i.tagName), "" == i.placeHolderTemplate && (i.placeHolderTemplate = "<" + i.tagName + ">&nbsp;</" + i.tagName + ">"), e(this.container).attr("data-listidx", t).mousedown(this.grabItem).bind("dragsort-uninit", this.uninit), this.styleDragHandlers(!0)
                },
                uninit: function () {
                    var t = a[e(this).attr("data-listidx")];
                    e(t.container).unbind("mousedown", t.grabItem).unbind("dragsort-uninit"), t.styleDragHandlers(!1)
                },
                getItems: function () {
                    return e(this.container).children(i.itemSelector)
                },
                styleDragHandlers: function (t) {
                    this.getItems().map(function () {
                        return e(this).is(i.dragSelector) ? this : e(this).find(i.dragSelector).get()
                    }).css("cursor", t ? "pointer" : "")
                },
                grabItem: function (t) {
                    var s = a[e(this).attr("data-listidx")],
                        n = e(t.target).closest("[data-listidx] > " + i.tagName).get(0),
                        o = s.getItems().filter(function () {
                            return this == n
                        }).size() > 0;
                    if (!(1 != t.which || e(t.target).is(i.dragSelectorExclude) || e(t.target).closest(i.dragSelectorExclude).size() > 0) && o) {
                        t.preventDefault();
                        for (var r = t.target; !e(r).is(i.dragSelector);) {
                            if (r == this) return;
                            r = r.parentNode
                        }
                        e(r).attr("data-cursor", e(r).css("cursor")), e(r).css("cursor", "move");
                        var l = this,
                            d = function () {
                                s.dragStart.call(l, t), e(s.container).unbind("mousemove", d)
                            };
                        e(s.container).mousemove(d).mouseup(function () {
                            e(s.container).unbind("mousemove", d), e(r).css("cursor", e(r).attr("data-cursor"))
                        })
                    }
                },
                dragStart: function (t) {
                    if (null != s && null != s.draggedItem && s.dropItem(), s = a[e(this).attr("data-listidx")], s.draggedItem = e(t.target).closest("[data-listidx] > " + i.tagName), i.dragStart.apply(s.draggedItem) === !1) return void(s.draggedItem = null);
                    s.draggedItem.attr("data-origpos", e(this).attr("data-listidx") + "-" + e(s.container).children().index(s.draggedItem));
                    var n = parseInt(s.draggedItem.css("marginTop")),
                        o = parseInt(s.draggedItem.css("marginLeft"));
                    if (s.offset = s.draggedItem.offset(), s.offset.top = t.pageY - s.offset.top + (isNaN(n) ? 0 : n) - 1, s.offset.left = t.pageX - s.offset.left + (isNaN(o) ? 0 : o) - 1, !i.dragBetween) {
                        var r = 0 == e(s.container).outerHeight() ? Math.max(1, Math.round(.5 + s.getItems().size() * s.draggedItem.outerWidth() / e(s.container).outerWidth())) * s.draggedItem.outerHeight() : e(s.container).outerHeight();
                        s.offsetLimit = e(s.container).offset(), s.offsetLimit.right = s.offsetLimit.left + e(s.container).outerWidth() - s.draggedItem.outerWidth(), s.offsetLimit.bottom = s.offsetLimit.top + r - s.draggedItem.outerHeight()
                    }
                    var l = s.draggedItem.height(),
                        d = s.draggedItem.width();
                    if ("tr" == i.tagName ? (s.draggedItem.children().each(function () {
                            e(this).width(e(this).width())
                        }), s.placeHolderItem = s.draggedItem.clone().attr("data-placeholder", !0), s.draggedItem.after(s.placeHolderItem), s.placeHolderItem.children().each(function () {
                            e(this).css({
                                borderWidth: 0,
                                width: e(this).width() + 1,
                                height: e(this).height() + 1
                            }).html("&nbsp;")
                        })) : (s.draggedItem.after(i.placeHolderTemplate), s.placeHolderItem = s.draggedItem.next().css({
                            height: l,
                            width: d
                        }).attr("data-placeholder", !0)), "td" == i.tagName) {
                        var h = s.draggedItem.closest("table").get(0);
                        e("<table id='" + h.id + "' style='border-width: 0px;' class='dragSortItem " + h.className + "'><tr></tr></table>").appendTo("body").children().append(s.draggedItem)
                    }
                    var c = s.draggedItem.attr("style");
                    s.draggedItem.attr("data-origstyle", c ? c : ""), s.draggedItem.css({
                        position: "absolute",
                        opacity: .8,
                        "z-index": 999,
                        height: l,
                    ...
                    }, s.scroll.scrollY = window.setInterval(function () {
                        if (i.scrollContainer != window) return void e(i.scrollContainer).scrollTop(e(i.scrollContainer).scrollTop() + s.scroll.moveY);
                        var t = e(i.scrollContainer).scrollTop();
                        (s.scroll.moveY > 0 && t < s.scroll.maxY || s.scroll.moveY < 0 && t > 0) && (e(i.scrollContainer).scrollTop(t + s.scroll.moveY), s.draggedItem.css("top", s.draggedItem.offset().top + s.scroll.moveY + 1))
                    }, 10), s.scroll.scrollX = window.setInterval(function () {
                        if (i.scrollContainer != window) return void e(i.scrollContainer).scrollLeft(e(i.scrollContainer).scrollLeft() + s.scroll.moveX);
                        var t = e(i.scrollContainer).scrollLeft();
                        (s.scroll.moveX > 0 && t < s.scroll.maxX || s.scroll.moveX < 0 && t > 0) && (e(i.scrollContainer).scrollLeft(t + s.scroll.moveX), s.draggedItem.css("left", s.draggedItem.offset().left + s.scroll.moveX + 1))
                    }, 10), e(a).each(function (e, t) {
                        t.createDropTargets(), t.buildPositionTable()
                    }), s.setPos(t.pageX, t.pageY), e(document).bind("mousemove", s.swapItems), e(document).bind("mouseup", s.dropItem), i.scrollContainer != window && e(window).bind("DOMMouseScroll mousewheel", s.wheel)
                },
                setPos: function (t, a) {
                    var n = a - this.offset.top,
                        o = t - this.offset.left;
                    i.dragBetween || (n = Math.min(this.offsetLimit.bottom, Math.max(n, this.offsetLimit.top)), o = Math.min(this.offsetLimit.right, Math.max(o, this.offsetLimit.left)));
                    var r = this.draggedItem.offsetParent().not("body").offset();
                    if (null != r && (n -= r.top, o -= r.left), i.scrollContainer == window) a -= e(window).scrollTop(), t -= e(window).scrollLeft(), a = Math.max(0, a - e(window).height() + 5) + Math.min(0, a - 5), t = Math.max(0, t - e(window).width() + 5) + Math.min(0, t - 5);
                    else {
                        var l = e(i.scrollContainer),
                            d = l.offset();
                        a = Math.max(0, a - l.height() - d.top) + Math.min(0, a - d.top), t = Math.max(0, t - l.width() - d.left) + Math.min(0, t - d.left)
                    }
                    s.scroll.moveX = 0 == t ? 0 : t * i.scrollSpeed / Math.abs(t), s.scroll.moveY = 0 == a ? 0 : a * i.scrollSpeed / Math.abs(a), this.draggedItem.css({
                        top: n,
                        left: o
                    })
                },
                wheel: function (t) {
                    if ((e.browser.safari || e.browser.mozilla) && s && i.scrollContainer != window) {
                        var a = e(i.scrollContainer),
                            n = a.offset();
                        if (t.pageX > n.left && t.pageX < n.left + a.width() && t.pageY > n.top && t.pageY < n.top + a.height()) {
                            var o = t.detail ? 5 * t.detail : t.wheelDelta / -2;
                            a.scrollTop(a.scrollTop() + o), t.preventDefault()
                        }
                    }
                },
                buildPositionTable: function () {
                    var t = [];
                    this.getItems().not([s.draggedItem[0], s.placeHolderItem[0]]).each(function (i) {
                        var a = e(this).offset();
                        a.right = a.left + e(this).outerWidth(), a.bottom = a.top + e(this).outerHeight(), a.elm = this, t[i] = a
                    }), this.pos = t
                },
                dropItem: function () {
                    if (null != s.draggedItem) {
                        var t = s.draggedItem.attr("data-origstyle");
                        if (s.draggedItem.attr("style", t), "" == t && s.draggedItem.removeAttr("style"), s.draggedItem.removeAttr("data-origstyle"), s.styleDragHandlers(!0), s.placeHolderItem.before(s.draggedItem), s.placeHolderItem.remove(), e("[data-droptarget], .dragSortItem").remove(), window.clearInterval(s.scroll.scrollY), window.clearInterval(s.scroll.scrollX), s.draggedItem.attr("data-origpos") != e(a).index(s) + "-" + e(s.container).children().index(s.draggedItem) && 0 == i.dragEnd.apply(s.draggedItem)) {
                            var n = s.draggedItem.attr("data-origpos").split("-"),
                                o = e(a[n[0]].container).children().not(s.draggedItem).eq(n[1]);
                            o.size() > 0 ? o.before(s.draggedItem) : 0 == n[1] ? e(a[n[0]].container).prepend(s.draggedItem) : e(a[n[0]].container).append(s.draggedItem)
                        }
                        return s.draggedItem.removeAttr("data-origpos"), s.draggedItem = null, e(document).unbind("mousemove", s.swapItems), e(document).unbind("mouseup", s.dropItem), i.scrollContainer != window && e(window).unbind("DOMMouseScroll mousewheel", s.wheel), !1
                    }
                },
                swapItems: function (t) {
                    if (null == s.draggedItem) return !1;
                    s.setPos(t.pageX, t.pageY);
                    for (var o = s.findPos(t.pageX, t.pageY), r = s, l = 0; - 1 == o && i.dragBetween && l < a.length; l++) o = a[l].findPos(t.pageX, t.pageY), r = a[l];
                    if (-1 == o) return !1;
                    var d = function () {
                            return e(r.container).children().not(r.draggedItem)
                        },
                        h = d().not(i.itemSelector).each(function (e) {
                            this.idx = d().index(this)
                        });
                    return null == n || n.top > s.draggedItem.offset().top || n.left > s.draggedItem.offset().left ? e(r.pos[o].elm).before(s.placeHolderItem) : e(r.pos[o].elm).after(s.placeHolderItem), h.each(function () {
                        var t = d().eq(this.idx).get(0);
                        this != t && d().index(this) < this.idx ? e(this).insertAfter(t) : this != t && e(this).insertBefore(t)
                    }), e(a).each(function (e, t) {
                        t.createDropTargets(), t.buildPositionTable()
                    }), n = s.draggedItem.offset(), !1
                },
                findPos: function (e, t) {
                    for (var i = 0; i < this.pos.length; i++)
                        if (this.pos[i].left < e && this.pos[i].right > e && this.pos[i].top < t && this.pos[i].bottom > t) return i;
                    return -1
                },
                createDropTargets: function () {
                    i.dragBetween && e(a).each(function () {
                        var t = e(this.container).find("[data-placeholder]"),
                            a = e(this.container).find("[data-droptarget]");
                        t.size() > 0 && a.size() > 0 ? a.remove() : 0 == t.size() && 0 == a.size() && ("td" == i.tagName ? e(i.placeHolderTemplate).attr("data-droptarget", !0).appendTo(this.container) : e(this.container).append(s.placeHolderItem.removeAttr("data-placeholder").clone().attr("data-droptarget", !0)), s.placeHolderItem.attr("data-placeholder", !0))
                    })
                }
            };
            r.init(), a.push(r)
...
function ($) {
    $.fn.iconpicker = function (options) {
        var self = this;
        return this.buttonSize = "sm", this.columns = 10, this.height = 400, this.extend(options), this.open = !1, this.allowedSizes = ["sm", "lg", "2x", "3x", "4x", "5x"], this.templates = {
            ...
            var t = "sm" == $(e.currentTarget).data("size") ? "" : "fa-" + $(e.currentTarget).data("size");
            self.$sizeSelector.find(".btn").removeClass("active"), $(e.currentTarget).addClass("active"), self.$container.find("i").removeClass("fa-lg fa-2x fa-3x fa-4x fa-5x").addClass(t), self.resize()
        }), this.createMenu = function () {
            this.icons = eval(this.icons), this.$menu = $("<div>", {
                "class": "icon-menu",
                style: "height:" + this.height + "px"
            }), this.filter !== !1 && (this.$filter = $(this.templates.filter), this.$menu.append(this.$filter)), this.sizeSelector !== !1 && (this.$sizeSelector = $(this.templates.sizes), this.$sizeSelector.find("a[data-size=" + this.buttonSize + "]").addClass("active"), this.$menu.append(this.$sizeSelector)), this.$container = $("<div>", {
            ...
            for (var i in this.icons) {
                ...
                button.html("<i class='fa fa-fw " + this.icons[i].selector + size + "'></i>"), this.$container.append(button)
            }
            ...
            var t = Math.ceil($(".icon").outerWidth(!0) * this.columns + this.scrollbarWidth) + "px",
                i = this.height - 2 * parseInt(this.$menu.css("padding-top"));
            i -= this.filter !== !1 ? this.$filter.outerHeight(!0) : 0, i -= this.sizeSelector !== !1 ? this.$sizeSelector.outerHeight(!0) : 0, this.$container.css({
                width: t,
                height: i
            })
